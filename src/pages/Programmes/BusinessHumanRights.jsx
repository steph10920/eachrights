...
/* =========================================================
   BUSINESS AND HUMAN RIGHTS PROGRAMME PAGE
...
export default function BusinessHumanRights() {
  return (
        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-bold leading-snug text-ink sm:text-3xl">
              Full programme details for Business and Human Rights Programme are being finalized.
            </h2>
