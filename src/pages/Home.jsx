...
const impactImages = [
  ...
  {
    image: impact2,
    eyebrow: "EMPOWERING COMMUNITIES",
    title: "Putting rights into practice.",
  },
  {
    image: impact3,
    eyebrow: "BUILDING OPPORTUNITIES",
    title: "Strengthening communities.",
  },
  {
    image: impact4,
    eyebrow: "ADVANCING JUSTICE",
    title: "Working together for lasting change.",
  },
];
...
export default function Home() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentImpactImage(
        (prev) => (prev + 1) % impactImages.length
      );
    }, 5000);
...
<section className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 sm:py-28 lg:grid-cols-2">
  ...
  <div>
    ...
    <p className="mt-6 text-base leading-8 text-ink/75">
      ...
      We work to promote, protect and advance
      Economic, Social and Cultural Rights for
      vulnerable and marginalized communities.
    </p>

    <p className="mt-4 text-base leading-8 text-ink/75">
      Our work spans Kenya, Uganda and Tanzania,
      with a focus on creating an enabling environment
      where people can enjoy their rights and live
      with dignity.
    </p>
  ...
  >
    ...
    <div className="p-5">
      ...
      <div className="flex items-center gap-4">
        ...
        <h3 className="text-2xl font-bold text-forest font-display">
          Our commitment
        </h3>
      ...
      <p className="mt-5 text-lg leading-8 text-ink/70">
        ...
        justice, dignity and the opportunity to enjoy
      ...
      <div className="mt-6 h-1 w-20 bg-forest-dark" />
        ...
        <section className="relative overflow-hidden bg-forest px-6 py-20 text-paper">
          ...
          <div className="absolute -left-32 bottom-0 h-72 w-72 rounded-full border-[30px] border-paper/5" />
          ...
          <div className="relative z-10 mx-auto max-w-7xl">
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div>
                ...
                <h2 className="mt-3 text-4xl font-bold font-display sm:text-5xl">
                  Quick view of achievements
                </h2>


                <p className="mt-5 max-w-xl leading-7 text-paper/65">
                  Our work is creating meaningful change
                  by supporting communities, expanding
                  opportunities and advancing social justice.
                </p>
                ...
                <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3">
                  ...
                  <div className="border border-paper/15 bg-paper/5 p-5 backdrop-blur-sm transition hover:-translate-y-1 hover:bg-paper/10">
                  ...
                  <div className="border border-paper/15 bg-paper/5 p-5 backdrop-blur-sm transition hover:-translate-y-1 hover:bg-paper/10 sm:col-span-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-paper/50">
                          Community and programme satisfaction
                        </p>
              ...
              {/* =============================================
                  RIGHT — IMPACT IMAGE SLIDER
              ============================================= */}

              <div className="relative">

                <div className="group relative overflow-hidden rounded-2xl border border-paper/10 bg-black/20 shadow-2xl">
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    >
                      ...
                      >
                        ...
                        <h3 className="mt-1 text-2xl font-bold font-display text-white sm:text-3xl">
                          {impactSlide.title}
                        </h3>
                    ...
                    <button
                      ...
                      className="absolute left-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/30 text-white opacity-0 backdrop-blur-md transition hover:bg-black/60 group-hover:opacity-100"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/30 text-white opacity-0 backdrop-blur-md transition hover:bg-black/60 group-hover:opacity-100"
                        ...
                        <span
                          className={`block h-2 rounded-full transition-all duration-300 ${
                            currentImpactImage === index
                              ? "w-8 bg-accent"
                              : "w-2 bg-paper/30 group-hover:bg-paper/60"
                          }`}
                        />
            ...
            <div className="grid items-center gap-14 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-6 max-w-xl leading-8 text-ink/70">
                  EACHRights uses a rights-based approach
                  to address structural inequalities and
                  strengthen the ability of communities and
                  institutions to advance human rights.
                </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-24">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl leading-7 text-ink/65">
              Our regional work connects communities,
              partners and stakeholders across East Africa
              to advance Economic, Social and Cultural Rights.
            </p>
        ...
        <section className="bg-forest px-6 py-24 text-center text-paper">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mx-auto mt-5 max-w-xl leading-8 text-paper/65">
              Whether through partnership, advocacy,
              research or support, there is a role for
              everyone in advancing human rights and
              social justice.
            </p>
