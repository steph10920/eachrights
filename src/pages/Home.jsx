...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-paper font-sans text-ink">
      ...
      {/* HERO IMAGE SLIDESHOW — reduced height, toned-down type/effects for a more professional look */}
      ...
      <main>
        <section className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 sm:py-28 lg:grid-cols-2">
          ...
          >
            ...
            <h3 className="mt-7 text-2xl font-bold text-forest font-display">Our commitment</h3>
        ...
        <section className="relative overflow-hidden bg-forest px-6 py-20 text-paper">
          ...
          <div className="relative z-10 mx-auto max-w-6xl text-center">
            ...
            <h2 className="mt-3 text-4xl font-bold sm:text-5xl font-display">Advancing rights since 2010.</h2>
            <p className="mx-auto mt-4 max-w-2xl leading-7 text-paper/65">
              Our work is rooted in evidence, community participation, advocacy and a commitment to social justice.
            </p>
            <div className="mt-12 grid grid-cols-2 gap-5 md:grid-cols-4">
              <div className="border border-dashed border-paper/20 p-6">
                <div className="text-4xl font-bold text-accent sm:text-5xl font-display"><CountUp end={15} duration={2} />+</div>
                <p className="mt-2 text-xs uppercase tracking-wider text-paper/60">Years of Work</p>
              </div>
              <div className="border border-dashed border-paper/20 p-6">
                <div className="text-4xl font-bold text-accent sm:text-5xl font-display"><CountUp end={3} duration={2} /></div>
                <p className="mt-2 text-xs uppercase tracking-wider text-paper/60">Countries</p>
              </div>
              <div className="border border-dashed border-paper/20 p-6">
                <div className="text-4xl font-bold text-accent sm:text-5xl font-display"><CountUp end={6} duration={2} /></div>
                <p className="mt-2 text-xs uppercase tracking-wider text-paper/60">Focus Areas</p>
              </div>
              <div className="border border-dashed border-paper/20 p-6">
                <div className="text-4xl font-bold text-accent sm:text-5xl font-display">ESC</div>
                <p className="mt-2 text-xs uppercase tracking-wider text-paper/60">Rights Focus</p>
              </div>
            </div>
          </div>
        </section>
