...
export default function WhatWeDo() {
  return (
    <main className="min-h-screen bg-paper font-sans text-ink">
      ...
      <section className="bg-forest px-6 py-20 text-paper">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 font-display text-2xl font-medium leading-relaxed sm:text-3xl">
            ...
            meaningful when people can exercise them.
          </p>
      ...
      <section className="bg-forest-light px-6 py-24 sm:px-8 lg:px-12 lg:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 font-display text-4xl font-bold tracking-tight text-forest sm:text-5xl">
              Engaging beyond programmes.
            </h2>

            <p className="mt-5 text-lg leading-8 text-ink/65">
              We also participate in national, regional and international
              human rights processes that strengthen accountability and bring
              community evidence into policy and decision-making spaces.
            </p>
          </div>
          ...
          <motion.div
            ...
            variants={gridVariants}
            className="mt-12 grid max-w-2xl gap-6"
          >
